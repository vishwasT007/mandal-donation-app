...
export const generateReceiptPDF = async (donationData) => {
  ...
  const shortId = uuidv4().split("-")[0]; // keep short
  ...
  // Return short URL (your Firebase function handles redirection)
  const shortURL = `https://tiroracharaja.in/receipt?id=${shortId}`;
  return shortURL;
};
